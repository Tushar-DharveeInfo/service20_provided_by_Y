window.appSettings = {
  ...
  CLOUDRUN_URL: 'https://n20-storage-cloudrun-mkvwooi2sa-uc.a.run.app',
  ...
  FIREBASE_BUCKET: 'n20-bucket-01',
  FIREBASE_LIBFOLDER: 'libfolder-01',
  FIREBASE_VSSFOLDER: 'vssfolder-01',
  FIREBASE_FSDB: 'default',
};
