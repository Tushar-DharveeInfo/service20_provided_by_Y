...
import { TReportAddressFields, TReportDataset, TReportDocTypeInput } from "../buy/generatereport/IGenerateReport";
...
/* Formats the document-type input (PO, Invoice, or Quote or Cart) into a display label for the _PO text object. */
