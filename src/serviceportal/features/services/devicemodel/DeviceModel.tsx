...
import { DeviceModelFEnums, Lib } from '../../../shared/alldefaultprops/devicemodel/DeviceModelEnums'
...
import { IDownloadCart } from '@n20a/libcart';
	...
	let featureTreeProps: IFeatureTree = {
		...
		onAddToDownloadCart: (node: ITreeNode) => {
			...
			if (props.addToDownloadCart) {
				props.addToDownloadCart({ Mfg: mfg, ProdNo: prodno, EQID, Filename: "" } as IDownloadCart)
			} else {
				alert(`mfg: ${mfg}\nprodno: ${prodno}\nEQID: ${EQID}`)
			}
		},
