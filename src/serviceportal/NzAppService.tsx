...
import { getBidCidMap } from './shared/bidcidmap/bidcidmap';//Yadav-comment after actual bid, cid data is available
...
function NzLoadContextAndVariables({ uniqueName, user, fbToken, onError, onSuccess }: INzApp) {
    ...
    useEffect(() => {
        ...
        const initializeData = async () => {
            ...
            const bidCidMap = getBidCidMap(user.id, user.email ?? "");
            debugger
            const role =
